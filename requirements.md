...
Немного изменена структура отчета. Файл с новой структурой и ее описанием: [Word-файл](./template-report.docx) (его можно скачать. Нажимаем на него, далее справа расположена кнопка загрузки).
