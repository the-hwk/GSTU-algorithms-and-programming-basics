...
Начиная с л.р. №4 для каждой разрабатываемой программы необходимо составлять набор тестов. Тесты необходимы для того, чтобы проверить правильно ли реализован алгоритм в программе. При этом тесты должны охватывать все возможные вариации входных данных.
